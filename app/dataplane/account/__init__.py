...
from app.platform.request_context import record_grok_account_selection
    ...
    async def reserve(
        ...
        *,
        ...
        record_grok_account_selection(
            ...
            mode_id=lease.mode_id,
            account_wait_ms=max(1, int((time.perf_counter() - selection_started) * 1000)),
        )
        return lease
